    ...
    return (
        <div className="w-80">
            <div className="grid grid-cols-1 gap-6">
                <Input label="Pick username" value={username} setValue={setUsername} />
                <Input label="What do your friend call you" value={name} setValue={setName} />
                <Input label="Bio" value={bio} setValue={setBio} />
                <Input label="Your avatar" value={avatar} setValue={setAvatar} />
